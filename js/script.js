...
let velicinaFonta = parseInt(localStorage.getItem("velicinaFonta")) || 100;

function primeniVelicinuFonta() {
  document.documentElement.style.fontSize = velicinaFonta + "%";
}

function povecajFont() {
  if (velicinaFonta < 150) {
    velicinaFonta += 10;
    localStorage.setItem("velicinaFonta", velicinaFonta);
    primeniVelicinuFonta();
  }
}
...
document.addEventListener("DOMContentLoaded", primeniVelicinuFonta);